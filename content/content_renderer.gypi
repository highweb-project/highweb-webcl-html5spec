...

{
  'dependencies': [
    ...
    '../device/applauncher/applauncher.gyp:device_applauncher',
    '../device/applauncher/applauncher.gyp:device_applauncher_mojo_bindings',
    '../device/calendar/calendar.gyp:device_calendar',
    '../device/calendar/calendar.gyp:device_calendar_mojo_bindings',
    '../device/contact/contact.gyp:device_contact',
    '../device/contact/contact.gyp:device_contact_mojo_bindings',
    '../device/cpu/devicecpu.gyp:device_cpu',
    '../device/cpu/devicecpu.gyp:device_cpu_mojo_bindings',
    '../device/gallery/devicegallery.gyp:device_gallery',
    '../device/gallery/devicegallery.gyp:device_gallery_mojo_bindings',
    '../device/sound/devicesound.gyp:device_sound',
    '../device/sound/devicesound.gyp:device_sound_mojo_bindings',
    '../device/storage/devicestorage.gyp:device_storage',
    '../device/storage/devicestorage.gyp:device_storage_mojo_bindings',
    '../device/messaging/messaging.gyp:device_messaging',
    '../device/messaging/messaging.gyp:device_messaging_mojo_bindings',
  ...
  'variables': {
    ...
    'private_renderer_sources': [
      ...
      'renderer/applauncher/applauncher_dispatcher.cc',
      'renderer/applauncher/applauncher_dispatcher.h',
      'renderer/calendar/calendar_dispatcher.cc',
      'renderer/calendar/calendar_dispatcher.h',
      'renderer/device_api/device_api_contact_manager.cc',
      'renderer/device_api/device_api_contact_manager.h',
      'renderer/device_api/device_api_permission_client.cc',
      'renderer/device_api/device_api_permission_client.h',
      'renderer/device_cpu/devicecpu_dispatcher.cc',
      'renderer/device_cpu/devicecpu_dispatcher.h',
      'renderer/device_gallery/devicegallery_dispatcher.cc',
      'renderer/device_gallery/devicegallery_dispatcher.h',
      'renderer/device_messaging/device_api_messaging_manager.cc',
      'renderer/device_messaging/device_api_messaging_manager.h',
      'renderer/device_sensors/device_proximity_event_pump.h',
      'renderer/device_sensors/device_proximity_event_pump.cc',
      'renderer/device_sound/devicesound_dispatcher.cc',
      'renderer/device_sound/devicesound_dispatcher.h',
      'renderer/device_storage/devicestorage_dispatcher.cc',
      'renderer/device_storage/devicestorage_dispatcher.h',
    ],
