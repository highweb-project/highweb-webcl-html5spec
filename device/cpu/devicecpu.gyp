...

{
  ...
  'targets': [
    {
      # GN version: //device/cpu:mojo_bindings
      'target_name': 'device_cpu_mojo_bindings',
      'type': 'static_library',
      'includes': [
    ...
    },
    {
      ...
      'dependencies': [
        ...
        'device_cpu_mojo_bindings',
      ],
      'defines': [
        'DEVICE_CPU_IMPLEMENTATION',
      ],
      'sources': [
      ...
      'targets': [
        {
          ...
          'variables': {
            'java_in_dir': '../../device/cpu/android/java',
          },
