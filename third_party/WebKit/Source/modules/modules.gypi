{
  ...
  'variables': {
    ...
    'modules_idl_files': [
      ...
      'applauncher/AppLauncher.idl',
      'applauncher/AppLauncherScriptCallback.idl',
      'applauncher/AppStatus.idl',
      'calendar/CalendarStatus.idl',
      'calendar/CalendarEventSuccessCallback.idl',
      'calendar/CalendarFindOptions.idl',
      'calendar/CalendarEventFilter.idl',
      'calendar/CalendarEvent.idl',
      'calendar/CalendarRepeatRule.idl',
      'calendar/CalendarEventErrorCallback.idl',
      'calendar/CalendarError.idl',
      'calendar/Calendar.idl',
      'device_contact/Contact.idl',
      'device_contact/ContactErrorCallback.idl',
      'device_contact/ContactAddress.idl',
      'device_contact/ContactObject.idl',
      'device_contact/ContactName.idl',
      'device_contact/ContactSuccessCallback.idl',
      'device_cpu/DeviceCpu.idl',
      'device_cpu/DeviceCpuStatus.idl',
      'device_cpu/DeviceCpuScriptCallback.idl',
      'device_gallery/DeviceGallery.idl',
      'device_gallery/GalleryErrorCallback.idl',
      'device_gallery/GalleryMediaObject.idl',
      'device_gallery/GallerySuccessCallback.idl',
      'device_gallery/MediaContent.idl',
      'device_messaging/Messaging.idl',
      'device_messaging/MessageObject.idl',
      'device_messaging/MessagingErrorCallback.idl',
      'device_messaging/MessagingSuccessCallback.idl',
      'device_messaging/MessagingEvent.idl',
      'device_proximity/DeviceProximityEvent.idl',
      'device_sound/DeviceSound.idl',
      'device_sound/DeviceSoundScriptCallback.idl',
      'device_sound/DeviceSoundStatus.idl',
      'device_storage/DeviceStorage.idl',
      'device_storage/DeviceStorageScriptCallback.idl',
      'device_storage/DeviceStorageStatus.idl',
      'webcl/WebCL.idl',
    ...
    'modules_dependency_idl_files': [
      ...
      'applauncher/NavigatorAppLauncher.idl',
      'calendar/WindowCalendar.idl',
      'device_contact/NavigatorContact.idl',
      'device_cpu/NavigatorDeviceCpu.idl',
      'device_gallery/NavigatorDeviceGallery.idl',
      'device_messaging/NavigatorMessaging.idl',
      'device_proximity/WindowDeviceProximity.idl',
      'device_sound/NavigatorDeviceSound.idl',
      'device_storage/NavigatorDeviceStorage.idl',
    ...
    'modules_dictionary_idl_files': [
      ...
      'applauncher/ApplicationInfo.idl',
      'calendar/CalendarInfo.idl',
      'device_contact/ContactFindOptions.idl',
      'device_gallery/GalleryFindOptions.idl',
      'device_messaging/MessageFindOptions.idl',
      'device_proximity/DeviceProximityEventInit.idl',
      'device_sound/DeviceVolume.idl',
      'device_storage/DeviceStorageInfo.idl',
      'webcl/WebCLImageDescriptor.idl',
      'webcl/WebCLKernelArgInfo.idl',
      'webcl/WebCLGLObjectInfo.idl',
    ],
    ...
    'generated_modules_dictionary_files': [
      ...
      '<(blink_modules_output_dir)/applauncher/ApplicationInfo.cpp',
      '<(blink_modules_output_dir)/applauncher/ApplicationInfo.h',
      '<(blink_modules_output_dir)/calendar/CalendarInfo.h',
      '<(blink_modules_output_dir)/calendar/CalendarInfo.cpp',
      '<(blink_modules_output_dir)/device_contact/ContactFindOptions.cpp',
      '<(blink_modules_output_dir)/device_contact/ContactFindOptions.h',
      '<(blink_modules_output_dir)/device_gallery/GalleryFindOptions.cpp',
      '<(blink_modules_output_dir)/device_gallery/GalleryFindOptions.h',
      '<(blink_modules_output_dir)/device_messaging/MessageFindOptions.cpp',
      '<(blink_modules_output_dir)/device_messaging/MessageFindOptions.h',
      '<(blink_modules_output_dir)/device_proximity/DeviceProximityEventInit.cpp',
      '<(blink_modules_output_dir)/device_proximity/DeviceProximityEventInit.h',
      '<(blink_modules_output_dir)/device_sound/DeviceVolume.cpp',
      '<(blink_modules_output_dir)/device_sound/DeviceVolume.h',
      '<(blink_modules_output_dir)/device_storage/DeviceStorageInfo.cpp',
      '<(blink_modules_output_dir)/device_storage/DeviceStorageInfo.h',
      '<(blink_modules_output_dir)/webcl/WebCLImageDescriptor.cpp',
      '<(blink_modules_output_dir)/webcl/WebCLImageDescriptor.h',
      '<(blink_modules_output_dir)/webcl/WebCLKernelArgInfo.cpp',
      '<(blink_modules_output_dir)/webcl/WebCLKernelArgInfo.h',
      '<(blink_modules_output_dir)/webcl/WebCLGLObjectInfo.cpp',
      '<(blink_modules_output_dir)/webcl/WebCLGLObjectInfo.h',
    ],
    'modules_files': [
      '<@(extra_blink_module_files)',
      '<@(generated_modules_dictionary_files)',
      ...
      'applauncher/AppLauncher.h',
      'applauncher/AppLauncherListener.cpp',
      'applauncher/AppLauncherListener.h',
      'applauncher/AppLauncherScriptCallback.h',
      'applauncher/AppStatus.cpp',
      'applauncher/AppStatus.h',
      'applauncher/NavigatorAppLauncher.cpp',
      'applauncher/NavigatorAppLauncher.h',
      'calendar/CalendarListener.cpp',
      'calendar/CalendarListener.h',
      'calendar/CalendarStatus.h',
      'calendar/CalendarStatus.cpp',
      'calendar/CalendarEventSuccessCallback.h',
      'calendar/CalendarFindOptions.h',
      'calendar/CalendarEventFilter.h',
      'calendar/CalendarEvent.h',
      'calendar/CalendarRepeatRule.h',
      'calendar/CalendarEventErrorCallback.h',
      'calendar/CalendarError.cpp',
      'calendar/CalendarError.h',
      'calendar/Calendar.cpp',
      'calendar/Calendar.h',
      'calendar/DOMWindowCalendar.cpp',
      'calendar/DOMWindowCalendar.h',
      'device_api/DeviceApiPermissionController.cpp',
      'device_api/DeviceApiPermissionController.h',
      'device_contact/NavigatorContact.cpp',
      'device_contact/NavigatorContact.h',
      'device_contact/Contact.cpp',
      'device_contact/Contact.h',
      'device_contact/ContactErrorCallback.h',
      'device_contact/ContactAddress.cpp',
      'device_contact/ContactAddress.h',
      'device_contact/ContactObject.cpp',
      'device_contact/ContactObject.h',
      'device_contact/ContactName.cpp',
      'device_contact/ContactName.h',
      'device_contact/ContactSuccessCallback.h',
      'device_cpu/DeviceCpu.cpp',
      'device_cpu/DeviceCpu.h',
      'device_cpu/DeviceCpuListener.cpp',
      'device_cpu/DeviceCpuListener.h',
      'device_cpu/DeviceCpuScriptCallback.h',
      'device_cpu/DeviceCpuStatus.cpp',
      'device_cpu/DeviceCpuStatus.h',
      'device_cpu/NavigatorDeviceCpu.cpp',
      'device_cpu/NavigatorDeviceCpu.h',
      'device_gallery/DeviceGallery.cpp',
      'device_gallery/DeviceGallery.h',
      'device_gallery/DeviceGalleryListener.cpp',
      'device_gallery/DeviceGalleryListener.h',
      'device_gallery/DeviceGalleryStatus.cpp',
      'device_gallery/DeviceGalleryStatus.h',
      'device_gallery/DeviceGalleryErrorCallback.h',
      'device_gallery/GalleryMediaObject.cpp',
      'device_gallery/GalleryMediaObject.h',
      'device_gallery/DeviceGallerySuccessCallback.h',
      'device_gallery/MediaContent.h',
      'device_gallery/NavigatorDeviceGallery.cpp',
      'device_gallery/NavigatorDeviceGallery.h',
      'device_messaging/Messaging.cpp',
      'device_messaging/Messaging.h',
      'device_messaging/MessagingEvent.cpp',
      'device_messaging/MessagingEvent.h',
      'device_messaging/MessageObject.cpp',
      'device_messaging/MessageObject.h',
      'device_messaging/MessagingSuccessCallback.h',
      'device_messaging/NavigatorMessaging.cpp',
      'device_messaging/NavigatorMessaging.h',
      'device_proximity/DeviceProximityController.cpp',
      'device_proximity/DeviceProximitytController.h',
      'device_proximity/DeviceProximityDispatcher.cpp',
      'device_proximity/DeviceProximityDispatcher.h',
      'device_proximity/DeviceProximityEvent.cpp',
      'device_proximity/DeviceProximityEvent.h',
      'device_sound/DeviceSound.cpp',
      'device_sound/DeviceSound.h',
      'device_sound/DeviceSoundListener.cpp',
      'device_sound/DeviceSoundListener.h',
      'device_sound/DeviceSoundScriptCallback.h',
      'device_sound/DeviceSoundStatus.cpp',
      'device_sound/DeviceSoundStatus.h',
      'device_sound/NavigatorDeviceSound.cpp',
      'device_sound/NavigatorDevcieSound.h',
      'device_storage/DeviceStorage.cpp',
      'device_storage/DeviceStorage.h',
      'device_storage/DeviceStorageListener.cpp',
      'device_storage/DeviceStorageListener.h',
      'device_storage/DeviceStorageScriptCallback.h',
      'device_storage/DeviceStorageStatus.cpp',
      'device_storage/DeviceStorageStatus.h',
      'device_storage/NavigatorDeviceStorage.cpp',
      'device_storage/NavigatorDeviceStorage.h',
      'webcl/WebCL.cpp',
      'webcl/WebCL.h',
      ...
      'webcl/WebCLInclude.h',
      'webcl/WebCLValueChecker.h',
      'webcl/WebCLValueChecker.cpp',
      ...
      'webcl/WebCLCallbackHandler.h',
      'webcl/WebCLCallbackHandler.cpp',
      'webcl/WebCLHTMLUtil.h',
      'webcl/WebCLHTMLUtil.cpp',
      'webcl/WebCLAPIBlocker.h',
      'webcl/WebCLAPIBlocker.cpp',
      'webcl/WebCLProgram.h',
      'webcl/WebCLProgram.cpp',
      'webcl/WebCLOperationHandler.h',
      'webcl/WebCLOperationHandler.cpp',
