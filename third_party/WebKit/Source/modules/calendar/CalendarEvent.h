...
class CalendarEvent final : public GarbageCollectedFinalized<CalendarEvent>, public ScriptWrappable {
...
private:
	...
	String mReminder;
	Member<CalendarRepeatRule> mRecurrence;
};
