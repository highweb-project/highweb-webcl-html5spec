...

{
  'variables': {
    'blink_public_sources': [
      ...
      "platform/WebAppLauncherListener.h",
      "platform/WebAppStatus.h",
      "platform/WebCalendarStatus.h",
      "platform/WebCalendarListener.h",
      "platform/WebDeviceProximityListener.h",
      "platform/modules/device_api/WebDeviceApiPermissionCheckRequest.h",
      "platform/modules/device_api/WebDeviceApiPermissionCheckClient.h",
      "platform/modules/device_gallery/WebDeviceGalleryListener.h",
      "platform/modules/device_gallery/WebDeviceGalleryStatus.h",
      "platform/modules/device_gallery/WebDeviceGalleryStruct.h",
      "platform/modules/device_systeminformation/WebDeviceCpuListener.h",
      "platform/modules/device_systeminformation/WebDeviceCpuStatus.h",
      "platform/modules/device_systeminformation/WebDeviceSoundListener.h",
      "platform/modules/device_systeminformation/WebDeviceSoundStatus.h",
      "platform/modules/device_systeminformation/WebDeviceStorageListener.h",
      "platform/modules/device_systeminformation/WebDeviceStorageStatus.h",
      "platform/modules/device_contact/WebDeviceContactFindOptions.h",
      "platform/modules/device_contact/WebDeviceContactParameter.h",
      "platform/modules/device_contact/WebDeviceContactAddress.h"
      "platform/modules/device_contact/WebDeviceContactName.h"
      "platform/modules/device_contact/WebDeviceContactObject.h",
      "platform/modules/device_contact/WebDeviceContactResultListener.h",
      "platform/modules/device_messaging/WebDeviceMessageFindOptions.h",
      "platform/modules/device_messaging/WebDeviceMessageObject.h",
      "platform/modules/device_messaging/WebDeviceMessageParameter.h",
      "platform/modules/device_messaging/WebDeviceMessageResultListener.h",
    ],
  },
}
